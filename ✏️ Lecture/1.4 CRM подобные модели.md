...
2. CRMP – модель, объемом дренирования которой является объем вокруг добывающей скважины, то есть у каждой добывающей скважины имеется свой поровый объем и уравнение записывается в следующем виде:
...
3. CRMIP – модель, объемом дренирования которой является зона между парой нагнетательная-добывающая скважины. Уравнение записывается в следующем виде:<br>
...
![Ступенчатый график изменения приемистости нагнетательной скважины от момента времени](../files/Pasted%20image%2020240131140047.png)<br>
...
![Кусочно-линейный график изменения приемистости нагнетательной скважины от момента времени](../files/Pasted%20image%2020240131143810.png)<br>
